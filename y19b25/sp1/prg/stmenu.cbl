	...
	WORKING-STORAGE SECTION.
	  ...
	  03 FIL               PIC X(60) VALUE 
	     'Define Country 	            /z/y19b25/sp1/prg/fmcy'.
          03 FIL               PIC X(60) VALUE
	     'Define Race                   /z/y19b25/sp1/prg/fmrc'.
	  03 FIL               PIC X(60) VALUE
             'Define Student Profile        /z/y19b25/sp1/prg/fmstd'.
	...
	MAIN-LOGIC.
	   ...
	   CALL   '/z/y19b25/sp1/lib/std/x-scrcp' USING S-WINDOW.
	   CANCEL '/z/y19b25/sp1/lib/std/x-scrcp'.
