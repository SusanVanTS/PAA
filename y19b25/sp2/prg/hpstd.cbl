      ...
      * VAN TZE SHAN	10/9/19	-	PAA	CODING
	...
	FILE SECTION.
	  ...
	  03 WS-T-STD-KEY	PIC X(06).
       ...
       SCREEN SECTION.
       01 MAIN-SCR.
	  03 LABEL LINE 1.5 COL 3.5 'Code  '.
	  03 LABEL COL 12.5 'Name'.
	  03 LABEL COL + 46 'Gender'.
	  03 LABEL COL + 3 'Country Code'.
	  03 LABEL COL + 2.8 'Race Code'.
	  03 LABEL COL + 4.2 'Religion Code'.
	  03 LIST-1 LIST-BOX USING WS-REC PAGED 3-D
	     LINE 2.5 COL 03 SIZE 106 CELL LINES T-SIZE 
	     NOTIFY-SELCHANGE
	     ...
	     EXCEPTION-VALUE W-DBLCLICK.
          03 PUSH-BUTTON 'Select' LINE 21.5 COL 40 SIZE 15 LINES 1.2
	     TERMINATION-VALUE = 13.
          03 PUSH-BUTTON 'Exit' LINE 21.5 COL 60 SIZE 15 LINES 1.2
	...
	DECLARATIVES.
      ...
      ********************************************************************
	   ...
	   DISPLAY FLOATING WINDOW COLOR 65793
	   LINES 22 SIZE 110 CELL SIZE = ENTRY-FIELD FONT SEPARATE
	   NO SCROLL NO WRAP
      ...
      * Get initial page by searching the 1st record.
	   ...
	   PERFORM WITH TEST AFTER
	  	   UNTIL K-ESCAPE OR K-ENTER OR K-L-DBLCLICK
		   	 ACCEPT MAIN-SCR
           END-PERFORM.
