	...
	LOCK-FILE-HANDLING SECTION.
      ...
      ********************************************************************
	   ...
	   TITLE 'Get Temp ID Lock File Creation'
           POP-UP S-WINDOW.
	   ...
	   OPEN I-O LOCK-FILE.
	   INITIALIZE LOCK-REC.
	   MOVE SPACES TO LOCK-KEY.
	   MOVE ZEROES TO LOCK-PADDING.
      ...
      * Call to change Mode & Group.
	   ...
	   STRING 'chmod 775', LOCK-DATANAME
	   ...
	   IF WS-STATUS NOT = ZEROS
	      ...
	      GO TO BEGIN-SUB.
           ...
           STRING 'chgrp cps', LOCK-DATANAME
		  DELIMITED BY SIZE INTO WS-COMMAND.
	   CALL   'SYSTEM' USING WS-COMMAND GIVING WS-STATUS.
	   CANCEL 'SYSTEM'.
	   IF WS-STATUS NOT = ZEROS
