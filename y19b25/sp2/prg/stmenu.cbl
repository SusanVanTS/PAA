	...
	WORKING-STORAGE SECTION.
	  ...
	  03 FIL               PIC X(60) VALUE 
	     'Define Country 	            /z/y19b25/sp2/prg/fmcy'.
          03 FIL               PIC X(60) VALUE
	     'Define Race                   /z/y19b25/sp2/prg/fmrc'.
	  03 FIL               PIC X(60) VALUE 
	     'Define Religion 	            /z/y19b25/sp2/prg/fmrg'.
	  03 FIL               PIC X(60) VALUE
             'Define Student Profile        /z/y19b25/sp2/prg/fmstd'.
          03 FIL	       PIC X(60) VALUE
	     'View & Print Country	    /z/y19b25/sp2/prg/vwcy'.
          03 FIL	       PIC X(60) VALUE
	     'View & Print Race	            /z/y19b25/sp2/prg/vwrc'.
          03 FIL	       PIC X(60) VALUE
	     'View & Print Religion 	    /z/y19b25/sp2/prg/vwrg'.
          03 FIL	       PIC X(60) VALUE
	     'View & Print Student Profile  /z/y19b25/sp2/prg/vwstd'.
          03 FIL               PIC X(360) VALUE SPACES.
	...
	MAIN-LOGIC.
	   ...
	   CANCEL '/z/y19b25/sp2/lib/std/x-scrcp'.
           SET ENVIRONMENT 'PA-USED-ID' TO 'y19b25'.
