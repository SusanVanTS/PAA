	...
	FILE SECTION.
	  ...
	  03 PRT-END-HHMM	PIC X(07).
       ...
       SCREEN SECTION.
       01 SELECT-SCR.
	  03 LABEL LINE 02 COL 04 'Religion Code:'.
	...
	DECLARATIVES.
      ...
      ********************************************************************
	   ...
	   MOVE 'Print Religion Listing' TO S-WINDOW-TITLE.
      ...
      ********************************************************************
	   ...
	   IF K-ESCAPE
	      ...
	      CALL	'/z/y19b25/sp2/prg/hprg' USING START-KEY, S-OK
		 ...
		 MOVE 102 TO S-CONTROL-ID
	      ...
	      CALL 	'/z/y19b25/sp2/prg/hprg' USING END-KEY, S-OK
	      CANCEL	'/z/y19b25/sp2/prg/hprg'
	      MOVE 102 TO S-CONTROL-ID. 
