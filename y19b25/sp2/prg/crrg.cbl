	...
	01 S-ANSWER		PIC X(01) VALUE 'N'.
	  ...
	  03 COL + 2 PIC X(40) FROM RG-DATANAME.
	...
	RG-FILE-HANDLING SECTION.
	   USE AFTER STANDARD ERROR PROCEDURE ON RG-FILE.
	   CALL	  '/v/cps/lib/std/f-status' USING RG-DATA.
