	...
	WORKING-STORAGE SECTION.
	  ...
	  03 FIL               PIC X(60) VALUE 
	     'Create Get Temp ID Lock File    /z/y19b25/sp2/prg/crlock'.
	  03 FIL               PIC X(60) VALUE 
	     'Create Configuration Data File  /z/y19b25/sp2/prg/crcfig'.
	  03 FIL               PIC X(60) VALUE 
	     'Create Country Data File        /z/y19b25/sp2/prg/crcy'.
          03 FIL               PIC X(60) VALUE
	     'Create Race Data File           /z/y19b25/sp2/prg/crrc'.
          03 FIL               PIC X(60) VALUE
	     'Create Religion Data File       /z/y19b25/sp2/prg/crrg'.
          03 FIL               PIC X(60) VALUE
             'Create Student Data File        /z/y19b25/sp2/prg/crstd'.
