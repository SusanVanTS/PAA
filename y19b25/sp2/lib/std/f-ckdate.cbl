	...
	01 WS-CENTURY.
	   03 WS-CENTURYYEAR		PIC 9(04).
	   03 WS-CENTURYMTH		PIC 9(02).
	   03 WS-CENTURYDD		PIC 9(02).
	...
	01 LINK-ERROR-CODE		PIC 9(06).
      ...
      *********************************************************************
	   ...
	   ACCEPT WS-CENTURY FROM CENTURY-DATE.
      ...
      *********************************************************************
	   ...
	   IF WS-YEAR < (WS-CENTURYYEAR - 100) OR
	      WS-YEAR > WS-CENTURYYEAR
              MOVE 100020 TO LINK-ERROR-CODE.
